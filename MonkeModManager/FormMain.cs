...
namespace MonkeModManager
{
    public partial class FormMain : Form
    {
        ...
        {
            var decodedMods = JSON.Parse(DownloadSite("https://raw.githubusercontent.com/astraldamonk/MonkeModInfo/master/modinfo.json"));
            var decodedGroups = JSON.Parse(DownloadSite("https://raw.githubusercontent.com/astraldamonk/MonkeModInfo/master/groupinfo.json"));
